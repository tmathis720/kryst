...
pub static SPECS: &[Spec] = &[
    ...
    Spec { flag: "-pc_approxinv_kind", key: "pc_approxinv_kind", arity: Arity::One, kind: ValueKind::Str, doc: "fsai | spai" },
    Spec { flag: "-pc_approxinv_levels", key: "pc_approxinv_levels", arity: Arity::One, kind: ValueKind::UInt, doc: "graph expansion depth (default 1)" },
    Spec { flag: "-pc_approxinv_max_per_col", key: "pc_approxinv_max_per_col", arity: Arity::One, kind: ValueKind::UInt, doc: "cap nnz per column (default 20)" },
    Spec { flag: "-pc_approxinv_drop_tol", key: "pc_approxinv_drop_tol", arity: Arity::One, kind: ValueKind::Float, doc: "post-solve prune threshold (default 1e-3)" },
    Spec { flag: "-pc_approxinv_reg", key: "pc_approxinv_reg", arity: Arity::One, kind: ValueKind::Float, doc: "diagonal regularization (default 1e-12)" },
    Spec { flag: "-pc_approxinv_max_cond", key: "pc_approxinv_max_cond", arity: Arity::One, kind: ValueKind::Float, doc: "max local cond estimate (reserved)" },
    Spec { flag: "-pc_approxinv_parallel", key: "pc_approxinv_parallel", arity: Arity::Zero, kind: ValueKind::Bool, doc: "enable rayon parallel build" },
    Spec {
        flag: "-pc_ilu_levels",
        key: "pc_ilu_levels",
        arity: Arity::One,
