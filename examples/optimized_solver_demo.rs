...
fn get_optimal_config(matrix_name: &str) -> OptimalConfig {
    match matrix_name {
        ...
        "e05r0100" => OptimalConfig {
            solver: "gmres",
            preconditioner: "amg",
            _description: "GMRES (AMG) - best for E05r0100 based on benchmarks",
        ...
        "fidap001" => OptimalConfig {
            solver: "cg",
            preconditioner: "jacobi",
            _description: "CG (Jacobi) - medium structural problem",
            expected_iterations: 500,
            fallback_solver: "gmres",
            fallback_pc: "none",
        },
        "sherman3" => OptimalConfig {
            solver: "gmres",
            preconditioner: "amg",
            _description: "GMRES (AMG) - large sparse matrix",
            expected_iterations: 500,
            fallback_solver: "bicgstab",
            fallback_pc: "none",
        },
        ...
        _ => OptimalConfig {
            solver: "gmres",
            preconditioner: "amg",
            _description: "GMRES (AMG) - general robust choice",
            expected_iterations: 500,
            fallback_solver: "bicgstab",
            fallback_pc: "none",
        },
