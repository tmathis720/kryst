...
#[cfg(feature = "mpi")]
fn broadcast_vec_u64(world: &mpi::topology::SimpleCommunicator, data: &mut Vec<u64>, root: i32) {
    use mpi::collective::Root;
    use mpi::traits::Communicator;
...
#[cfg(feature = "mpi")]
fn broadcast_vec_f64(world: &mpi::topology::SimpleCommunicator, data: &mut Vec<f64>, root: i32) {
    use mpi::collective::Root;
    use mpi::traits::Communicator;
    let mut len = if world.rank() == root {
        data.len() as u64
